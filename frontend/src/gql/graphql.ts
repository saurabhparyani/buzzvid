...
export type GetPostsByUserIdQuery = { __typename?: 'Query', getPostsByUserId: Array<{ __typename?: 'PostType', id: number, text: string, video?: string | null, user: { __typename?: 'User', fullname: string, email: string, id: number, image?: string | null, googleImage?: string | null } }> };
